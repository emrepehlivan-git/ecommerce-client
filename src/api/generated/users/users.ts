...
const {mutation: mutationOptions} = options ?
 ...
 , queryClient?: QueryClient): UseMutationResult<
    ...
    export const getApiV1UsersPermissions = (
 ...
 signal?: AbortSignal
      ...
      {url: `/api/v1/Users/permissions`, method: 'GET', signal
    },
      );
    }
  

export const getGetApiV1UsersPermissionsQueryKey = () => {
    return [`/api/v1/Users/permissions`] as const;
    }

    
export const getGetApiV1UsersPermissionsInfiniteQueryOptions = <TData = InfiniteData<Awaited<ReturnType<typeof getApiV1UsersPermissions>>>, TError = ProblemDetails>( options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getApiV1UsersPermissions>>, TError, TData>>, }
) => {

const {query: queryOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetApiV1UsersPermissionsQueryKey();

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiV1UsersPermissions>>> = ({ signal }) => getApiV1UsersPermissions(signal);

      

      

   return  { queryKey, queryFn,   staleTime: 10000,  ...queryOptions} as UseInfiniteQueryOptions<Awaited<ReturnType<typeof getApiV1UsersPermissions>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type GetApiV1UsersPermissionsInfiniteQueryResult = NonNullable<Awaited<ReturnType<typeof getApiV1UsersPermissions>>>
export type GetApiV1UsersPermissionsInfiniteQueryError = ProblemDetails


export function useGetApiV1UsersPermissionsInfinite<TData = InfiniteData<Awaited<ReturnType<typeof getApiV1UsersPermissions>>>, TError = ProblemDetails>(
  options: { query:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getApiV1UsersPermissions>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof getApiV1UsersPermissions>>,
          TError,
          Awaited<ReturnType<typeof getApiV1UsersPermissions>>
        > , 'initialData'
      >, }
...
export function useGetApiV1UsersPermissionsInfinite<TData = InfiniteData<Awaited<ReturnType<typeof getApiV1UsersPermissions>>>, TError = ProblemDetails>(
  options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getApiV1UsersPermissions>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseInfiniteQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export function useGetApiV1UsersPermissionsInfinite<TData = InfiniteData<Awaited<ReturnType<typeof getApiV1UsersPermissions>>>, TError = ProblemDetails>(
 ...
 , queryClient?: QueryClient 
  ...
  const queryOptions = getGetApiV1UsersPermissionsInfiniteQueryOptions(options)
...
export const getGetApiV1UsersPermissionsQueryOptions = <TData = Awaited<ReturnType<typeof getApiV1UsersPermissions>>, TError = ProblemDetails>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiV1UsersPermissions>>, TError, TData>>, }
) => {
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetApiV1UsersPermissionsQueryKey();
   ...
   return  { queryKey, queryFn,   staleTime: 10000,  ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiV1UsersPermissions>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type GetApiV1UsersPermissionsQueryResult = NonNullable<Awaited<ReturnType<typeof getApiV1UsersPermissions>>>
export type GetApiV1UsersPermissionsQueryError = ProblemDetails


export function useGetApiV1UsersPermissions<TData = Awaited<ReturnType<typeof getApiV1UsersPermissions>>, TError = ProblemDetails>(
  options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiV1UsersPermissions>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof getApiV1UsersPermissions>>,
          TError,
          Awaited<ReturnType<typeof getApiV1UsersPermissions>>
...
export function useGetApiV1UsersPermissions<TData = Awaited<ReturnType<typeof getApiV1UsersPermissions>>, TError = ProblemDetails>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiV1UsersPermissions>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export function useGetApiV1UsersPermissions<TData = Awaited<ReturnType<typeof getApiV1UsersPermissions>>, TError = ProblemDetails>(
 ...
 , queryClient?: QueryClient 
  ...
  const queryOptions = getGetApiV1UsersPermissionsQueryOptions(options)
